...
$role2=$r[$num-1];
 ...
 $subject="Role change";
$message="hi\n\n Dear user your role has been updated to $role2";
...
<div class="d2 col-lg-8 col-xs-8">
	...
	?>
	<div style="height:350px;width:900px;overflow-x: hidden;">
	<table cellpadding="3px" style="border:1px solid;border: 1px solid;border-color: lightgrey;width: 99%;overflow:scroll;height:100px;">
	<tr style="background-color: #367fa9;font-size: 22px;font-family: cursive;color-rendering: optimizeQuality;color: white;">
	<td style="padding-left: 35px;margin-right: -1px;padding-top: 19px;padding-bottom: 10px;"></td>
	<td style="padding-left: 35px;margin-right: -1px;padding-top: 19px;padding-bottom: 10px;">Name</td>
	<td style="padding-left: 35px;margin-right: -1px;padding-top: 19px;padding-bottom: 10px;">Lastname</td>
	<td  style="padding-left: 35px;margin-right: -1px; width: 43%;padding-top: 19px;padding-bottom: 10px;">Email-Id</td>
	<td  style="padding-left: 35px;margin-right: -1px; width: 43%;padding-top: 19px;padding-bottom: 10px;">Role</td>
	</tr>
...
<input type="hidden" name="s[]" value="<?php '.$email[$i].'; ?>">
	</td>
	<td style="padding: 10px 37px;font-size: 16px;font-family: sans-serif;color: #367fa9;"><?php echo $firstName[$i]; ?></td>
	<td style="padding: 10px 37px;font-size: 16px;font-family: sans-serif;color: #367fa9;"><?php echo $lastName[$i]; ?></td>
	<td style="padding: 10px 37px;font-size: 16px;font-family: sans-serif;color: #367fa9;"><?php echo $email[$i]; ?></td>
